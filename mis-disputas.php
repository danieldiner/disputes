...
<html lang="en">
  <head>
    ...
    <title>Geenius Store - Disputas</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Geenius Store - Disputas</a>
        </div>
    ...
    <div class="col-md-12">
      ...
      <!-- Default panel contents -->
        <div class="panel-heading">Disputas creadas</div>
          <table class="table">
            <thead>
              <tr>
                ...
                <th>Vendedor</th>
                <th>Mail de comprador</th>
                <th>Razón de disputa</th>
    ...
    <script src="js/mis-disputas.js"></script>
